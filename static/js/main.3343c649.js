...
// EXTERNAL MODULE: ../../packages/cli/doc-core/src/theme-default/index.ts + 30 modules
var theme_default = __webpack_require__(6610);
...
/* harmony export */ });
/* unused harmony exports QUERY_REGEXP, HASH_REGEXP, MDX_REGEXP, externalLinkRE, addLeadingSlash, removeLeadingSlash, removeTrailingSlash, parseUrl, withoutHash */
...
// EXTERNAL MODULE: ../../packages/cli/doc-core/node_modules/virtual-global-styles.js
var virtual_global_styles = __webpack_require__(20456);
// EXTERNAL MODULE: ../../node_modules/.pnpm/react@18.2.0/node_modules/react/index.js
var react = __webpack_require__(52983);
// EXTERNAL MODULE: ../../node_modules/.pnpm/react-helmet-async@1.3.0_biqbaboplfbrettd7655fr4n2y/node_modules/react-helmet-async/lib/index.module.js
var index_module = __webpack_require__(63744);
...
if(pathname===currentUrl.pathname&&search===currentUrl.search&&hash&&link.classList.contains('header-anchor')){e.preventDefault();history.pushState(null,'',hash);// use smooth scroll when clicking on header anchor links
...
const activate=(links,index)=>{if(links[index]){links[index].classList.add('aside-active');const id=links[index].getAttribute('href');const tocIndex=headers.findIndex(item=>item===id);const currentLink=aside===null||aside===void 0?void 0:aside.querySelector(`a[href="#${id===null||id===void 0?void 0:id.slice(1)}"]`);if(currentLink){if(prevActiveLink){prevActiveLink.classList.remove('aside-active');}prevActiveLink=currentLink;// Activate the a link element in aside
...
;// CONCATENATED MODULE: ../../packages/cli/doc-core/src/theme-default/components/Aside/index.module.scss
// extracted by mini-css-extract-plugin
/* harmony default export */ const Aside_index_module = ({});
...
// EXTERNAL MODULE: ../../packages/cli/doc-core/src/theme-default/logic/utils.ts
var logic_utils = __webpack_require__(22770);
// EXTERNAL MODULE: ../../packages/cli/doc-core/src/runtime/utils.ts
...
// EXTERNAL MODULE: ../../packages/cli/doc-core/src/theme-default/logic/useSidebarData.ts
var useSidebarData = __webpack_require__(30918);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@remix-run+router@1.2.0/node_modules/@remix-run/router/dist/router.js
var router = __webpack_require__(29133);
// EXTERNAL MODULE: ../../packages/cli/doc-core/node_modules/virtual-routes.js
var virtual_routes = __webpack_require__(63610);
...
const matchCache=new WeakMap();const match=item=>{if(matchCache.has(item)){return matchCache.get(item);}if(item.link&&activeMatcher(item.link)){matchCache.set(item,true);return true;}if('items'in item){const result=item.items.some(child=>match(child));if(result){matchCache.set(item,true);return true;}}matchCache.set(item,false);return false;};const traverse=item=>{if('items'in item){item.items.forEach(traverse);if(match(item)){item.collapsed=false;}}};sidebarData.forEach(traverse);setSidebarData(rawSidebarData.filter(Boolean).flat());},[props.sidebarData,pathname]);const removeLangPrefix=path=>{return path.replace(langRoutePrefix,'');};const activeMatcher=path=>(0,logic_utils/* isActive */.z)((0,runtime_utils/* removeBase */.E9)(removeLangPrefix(pathname)),removeLangPrefix(path),true);const preloadLink=link=>{const match=(0,router/* matchRoutes */.fp)(virtual_routes/* routes */._,link);if(match!==null&&match!==void 0&&match.length){const{route}=match[0];route.preload();}};return/*#__PURE__*/(0,jsx_runtime.jsx)("aside",{className:`modern-scrollbar ${Siderbar_index_module.sidebar} ${isSidebarOpen?Siderbar_index_module.open:''}`,children:/*#__PURE__*/(0,jsx_runtime.jsx)("div",{m:"t-1",children:/*#__PURE__*/(0,jsx_runtime.jsx)("nav",{children:sidebarData.map((item,index)=>{var _collapsed;return/*#__PURE__*/(0,jsx_runtime.jsx)(SidebarItemComp,{id:String(index),item:item,depth:0,activeMatcher:activeMatcher// The siderbarData is stable, so it's safe to use index as key
...
function DocLayout(props){var _ref,_frontmatter$outline,_frontmatter$overview;const{beforeDocFooter,beforeDoc,afterDoc,beforeOutline,afterOutline}=props;const{toc=[],siteData,frontmatter}=(0,hooks/* usePageData */.V)();const headers=toc;const{themeConfig}=siteData;const localesData=(0,useLocaleSiteData/* useLocaleSiteData */.M)();const sidebar=localesData.sidebar||[];const{pathname}=(0,dist/* useLocation */.TH)();const{items:sidebarData}=(0,useSidebarData/* useSidebarData */.t)();const langRoutePrefix=(0,utils/* normalizeSlash */.Kw)(localesData.langRoutePrefix||'');// siderbar Priority
...
const DEFAULT_HERO={name:'modern',text:'modern ssg',tagline:'modern ssg',actions:[],image:undefined};function HomeHero(){var _hero$image,_hero$image2;const{frontmatter}=(0,hooks/* usePageData */.V)();const hero=(frontmatter===null||frontmatter===void 0?void 0:frontmatter.hero)||DEFAULT_HERO;const hasImage=hero.image!==undefined;return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{m:"auto",p:"t-12 x-6 b-12 sm:t-0 sm:x-8 sm:x-16 md:t-20 md:x-16 md:b-16",children:/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"max-w-1152px",m:"auto",flex:"~ col md:row",children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{order:"2 md:1",flex:"~ col",className:`max-w-592px ${hasImage?'m-0 text-left':'m-auto text-center'}`,children:[/*#__PURE__*/(0,jsx_runtime.jsx)("h1",{font:"bold",text:"3xl sm:5xl md:6xl",m:"auto md:0",p:"md:b-3 lg:b-5",className:"max-w-392px sm:max-w-576px",children:/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:HomeHero_index_module.clip,children:hero.name})}),/*#__PURE__*/(0,jsx_runtime.jsx)("p",{m:"x-auto md:0",text:"3xl sm:5xl md:6xl",font:"bold",p:"b-2",className:"max-w-392px sm:max-w-576px",children:hero.text}),/*#__PURE__*/(0,jsx_runtime.jsx)("p",{p:"t-4",m:"auto md:0",text:"sm sm:xl md:2xl text-2",font:"medium",className:"whitespace-pre-wrap max-w-392px sm:max-w-576px",children:hero.tagline}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{flex:"~ wrap",className:`${hasImage?'justify-start':'justify-center gap-3'}`,m:"-1.5",p:"t-8",children:hero.actions.map(action=>/*#__PURE__*/(0,jsx_runtime.jsx)("div",{p:"1",flex:"shrink-0",children:/*#__PURE__*/(0,jsx_runtime.jsx)(Button,{type:"a",text:action.text,href:(0,utils/* normalizeHref */.yc)(action.link),theme:action.theme})},action.link))})]}),hasImage?/*#__PURE__*/(0,jsx_runtime.jsx)("div",{w:"sm:max-60",h:"sm:max-60",flex:"md:center",m:"auto",order:"1 md:2",display:"flex sm:flex md:none lg:flex",children:/*#__PURE__*/(0,jsx_runtime.jsx)("img",{src:(_hero$image=hero.image)===null||_hero$image===void 0?void 0:_hero$image.src,alt:(_hero$image2=hero.image)===null||_hero$image2===void 0?void 0:_hero$image2.alt})}):null]})});}
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "s": () => (/* binding */ getSidebarGroupData),
/* harmony export */   "t": () => (/* binding */ useSidebarData)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(52983);
/* harmony import */ var _useLocaleSiteData__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(35638);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(22770);
/* harmony import */ var _runtime__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(71837);
/* harmony import */ var _runtime__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(23517);
const getSidebarGroupData=(sidebar,currentPathname)=>{for(const name of Object.keys(sidebar)){// Such as `/api/`，it will return all the sidebar group
if((0,_utils__WEBPACK_IMPORTED_MODULE_1__/* .isEqualPath */ .p)((0,_runtime__WEBPACK_IMPORTED_MODULE_2__/* .withBase */ .pJ)(name),currentPathname)){return{group:'Documentation',items:sidebar[name]};}// Such as `/guide/getting-started`, it will return the guide groups and the group name `Introduction`
const result=sidebar[name].find(group=>{const match=item=>{const equalFunc=()=>(0,_utils__WEBPACK_IMPORTED_MODULE_1__/* .isEqualPath */ .p)((0,_runtime__WEBPACK_IMPORTED_MODULE_2__/* .withBase */ .pJ)(item.link),currentPathname);if('items'in item){// If the current path is the same as the group link, return true
if(equalFunc()){return true;}return item.items.some(i=>match(i));}else{return equalFunc();}};return match(group);});if(result){const sidebarGroup=sidebar[name];return{group:result.text||'',items:sidebarGroup};}}return{group:'Documentation',items:[]};};function useSidebarData(){var _localeData$sidebar;const localeData=(0,_useLocaleSiteData__WEBPACK_IMPORTED_MODULE_3__/* .useLocaleSiteData */ .M)();const sidebar=(_localeData$sidebar=localeData.sidebar)!==null&&_localeData$sidebar!==void 0?_localeData$sidebar:{};const{pathname}=(0,_runtime__WEBPACK_IMPORTED_MODULE_4__/* .useLocation */ .TH)();const[sidebarData,setSidebarData]=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(getSidebarGroupData(sidebar,pathname));(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{setSidebarData(getSidebarGroupData(sidebar,pathname));},[location.pathname]);return sidebarData;}
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "p": () => (/* binding */ isEqualPath),
/* harmony export */   "z": () => (/* binding */ isActive)
/* harmony export */ });
/* harmony import */ var _runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(71837);
/* harmony import */ var _runtime__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(60205);
function isEqualPath(a,b){return (0,_runtime__WEBPACK_IMPORTED_MODULE_0__/* .withBase */ .pJ)((0,_runtime__WEBPACK_IMPORTED_MODULE_1__/* .normalizeHref */ .yc)(a))===(0,_runtime__WEBPACK_IMPORTED_MODULE_0__/* .withBase */ .pJ)((0,_runtime__WEBPACK_IMPORTED_MODULE_1__/* .normalizeHref */ .yc)(b));}function isActive(currentPath,targetLink,strict=false){if(!targetLink){return false;}if(strict){return isEqualPath(currentPath,targetLink);}else{return isEqualPath(currentPath,targetLink)||currentPath.startsWith(targetLink);}}
...
},title:card.title,desc:card.desc,img:card.img},cardIndex);});return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:pages_index_module.flowContainer,children:[isWeb&&/*#__PURE__*/(0,jsx_runtime.jsx)("img",{className:`${pages_index_module.flowLine} ${isWeb?'':pages_index_module.flowLineMobile}`,src:flowLineImg,style:{width:'1px'},alt:"flow line"}),isWeb?renderedWebCards:renderedMobileCards]});};const renderContentCards=cards=>cards.map((card,cardIndex)=>/*#__PURE__*/(0,jsx_runtime.jsx)(components_ContentCard,{title:card.title,desc:card.desc,img:card.img,href:card.href},cardIndex));function initPageStyle(){if(typeof window!=='undefined'){document.documentElement.classList.add('dark');const navDom=document.querySelector('.dark .modern-doc-nav');const appearanceDom=document.querySelector('.modern-doc-appearance');if(navDom){navDom.style.backgroundColor='#000';}if(appearanceDom){appearanceDom.style.display='none';}return()=>{document.documentElement.classList.remove('dark');if(navDom){navDom.style.backgroundColor='';}if(appearanceDom){appearanceDom.style.display='block';}};}}function Home(){const bestPraticeCards=renderContentCards(bestPractice);let count=0;const{pathname}=(0,dist/* useLocation */.TH)();(0,react.useEffect)(()=>{const restore=initPageStyle();return()=>{restore===null||restore===void 0?void 0:restore();};},[pathname]);return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(HomepageHeader,{}),/*#__PURE__*/(0,jsx_runtime.jsxs)("main",{className:pages_index_module["homepage-main"],children:[/*#__PURE__*/(0,jsx_runtime.jsxs)(Featurelayout,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(components_SecondaryTitle,{seqNum:++count,children:"\u6781\u81F4\u7684\u5F00\u53D1\u8005\u4F53\u9A8C"}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:pages_index_module.cardContainer,children:bestPraticeCards})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)(Featurelayout,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(components_SecondaryTitle,{seqNum:++count,children:"\u63D0\u4F9B Web \u5F00\u53D1\u5168\u6D41\u7A0B"}),/*#__PURE__*/(0,jsx_runtime.jsx)(NoSSR,{children:/*#__PURE__*/(0,jsx_runtime.jsx)(FlowCards,{cards:flowCards})})]}),/*#__PURE__*/(0,jsx_runtime.jsx)(QuickStartCard,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(theme_Footer,{})]})]});}/* eslint-enable */
// EXTERNAL MODULE: ../../packages/cli/doc-core/src/theme-default/logic/useLocaleSiteData.ts
var useLocaleSiteData = __webpack_require__(35638);
...
const SocialLinks=({socialLinks})=>{const moreThanThree=socialLinks.length>3;const shownLinks=[];const hiddenLinks=[];socialLinks.forEach((item,index)=>{if(index<3){shownLinks.push(item);}else{hiddenLinks.push(item);}});const[moreLinksVisible,setMoreLinksVisible]=(0,react.useState)(false);return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:`social-links ${SocialLinks_index_module.menuItem} flex-center`,pos:"relative",onMouseLeave:()=>setMoreLinksVisible(false),children:[/*#__PURE__*/(0,jsx_runtime.jsx)(ShownLinks,{links:shownLinks,moreIconVisible:moreThanThree,mouseEnter:()=>setMoreLinksVisible(true)}),moreLinksVisible?/*#__PURE__*/(0,jsx_runtime.jsx)(HiddenLinks,{links:hiddenLinks}):null]});};
...
const SvgSearch = props => /*#__PURE__*/react.createElement("svg", search_extends({
  ...
  fill: "var(--modern-c-gray)",
  d: "m29 27.586l-7.552-7.552a11.018 11.018 0 1 0-1.414 1.414L27.586 29ZM4 13a9 9 0 1 1 9 9a9.01 9.01 0 0 1-9-9Z"
})));
/* harmony default export */ const assets_search = (SvgSearch);
...
;// CONCATENATED MODULE: ../../packages/cli/doc-core/src/theme-default/components/Search/assets/close.svg
var close_path;
...
/* harmony default export */ const assets_close = (SvgClose);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@babel+runtime@7.18.6/node_modules/@babel/runtime/helpers/esm/classPrivateMethodInitSpec.js
var classPrivateMethodInitSpec = __webpack_require__(23180);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@babel+runtime@7.18.6/node_modules/@babel/runtime/helpers/esm/classPrivateFieldInitSpec.js
var classPrivateFieldInitSpec = __webpack_require__(68633);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@babel+runtime@7.18.6/node_modules/@babel/runtime/helpers/esm/classPrivateMethodGet.js
var classPrivateMethodGet = __webpack_require__(82882);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@babel+runtime@7.18.6/node_modules/@babel/runtime/helpers/esm/classPrivateFieldGet.js + 1 modules
var classPrivateFieldGet = __webpack_require__(20784);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@babel+runtime@7.18.6/node_modules/@babel/runtime/helpers/esm/classPrivateFieldSet.js + 1 modules
var classPrivateFieldSet = __webpack_require__(39106);
// EXTERNAL MODULE: ../../node_modules/.pnpm/lodash-es@4.17.21/node_modules/lodash-es/uniqBy.js + 9 modules
var uniqBy = __webpack_require__(1718);
;// CONCATENATED MODULE: ../../packages/cli/doc-core/src/theme-default/components/Search/logic/util.ts
...
let matchedParent=false;for(let i=currentIndex-1;i>=0;i--){const header=rawHeaders[i];if(header.depth>1&&header.depth===current.depth-1){current=header;currentIndex=i;res.unshift(current);matchedParent=true;break;}}if(!matchedParent){break;}}return res;}function formatText(text){return text.length>MAX_TITLE_LENGTH?`${text.slice(0,MAX_TITLE_LENGTH)}...`:text;}function normalizeTextCase(text){return text.toLowerCase().normalize('NFD').replace(/[\u0300-\u036f]/g,'');}
// EXTERNAL MODULE: ../../node_modules/.pnpm/flexsearch@0.6.32/node_modules/flexsearch/dist/flexsearch.min.js
var flexsearch_min = __webpack_require__(11533);
var flexsearch_min_default = /*#__PURE__*/__webpack_require__.n(flexsearch_min);
;// CONCATENATED MODULE: ../../packages/cli/doc-core/src/theme-default/components/Search/logic/providers/LocalProvider.ts
/**
 * The local search provider for Modern.js Doc.
 * Powered by FlexSearch. https://github.com/nextapps-de/flexsearch
 */const cjkRegex=/[\|\u3131-\u3163\uAC00-\uD7A3]|[\u3400-\u4DB5\u4E00-\u9FCC\uFA0E\uFA0F\uFA11\uFA13\uFA14\uFA1F\uFA21\uFA23\uFA24\uFA27-\uFA29]|(?:[\uD840-\uD868](?![\uDC00-\uDFFF]))(?:(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF])|(?:\uD869(?![\uDC00-\uDFFF]))(?:(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDED6\uDF00-\uDFFF])|(?:[\uD86A-\uD86C](?![\uDC00-\uDFFF]))(?:(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF])|(?:\uD86D(?![\uDC00-\uDFFF]))(?:(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDF34\uDF40-\uDFFF])|(?:\uD86E(?![\uDC00-\uDFFF]))(?:(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDC1D])|[\u3041-\u3096]|[\u30A1-\u30FA]/gi;var _index=/*#__PURE__*/new WeakMap();var _cjkIndex=/*#__PURE__*/new WeakMap();var _getPages=/*#__PURE__*/new WeakSet();class LocalProvider{constructor(){(0,classPrivateMethodInitSpec/* default */.Z)(this,_getPages);(0,classPrivateFieldInitSpec/* default */.Z)(this,_index,{writable:true,value:void 0});(0,classPrivateFieldInitSpec/* default */.Z)(this,_cjkIndex,{writable:true,value:void 0});}async init(options){const{currentLang}=options;const pagesForSearch=(await (0,classPrivateMethodGet/* default */.Z)(this,_getPages,_getPages2).call(this)).filter(page=>page.lang===currentLang).map(page=>(0,objectSpread2/* default */.Z)((0,objectSpread2/* default */.Z)({},page),{},{normalizedContent:normalizeTextCase(page.content),headers:page.toc.map(header=>normalizeTextCase(header.text)).join(' '),normalizedTitle:normalizeTextCase(page.title)}));const createOptions={tokenize:'full',async:true,doc:{id:'routePath',field:['normalizedTitle','headers','normalizedContent']},cache:100,split:/\W+/};// Init Search Indexes
// English Index
(0,classPrivateFieldSet/* default */.Z)(this,_index,flexsearch_min_default().create(createOptions));// CJK: Chinese, Japanese, Korean
(0,classPrivateFieldSet/* default */.Z)(this,_cjkIndex,flexsearch_min_default().create((0,objectSpread2/* default */.Z)((0,objectSpread2/* default */.Z)({},createOptions),{},{tokenize(str){const cjkWords=[];let m=null;do{m=cjkRegex.exec(str);if(m){cjkWords.push(m[0]);}}while(m);return cjkWords;}})));(0,classPrivateFieldGet/* default */.Z)(this,_index).add(pagesForSearch);(0,classPrivateFieldGet/* default */.Z)(this,_cjkIndex).add(pagesForSearch);}async search(query){var _classPrivateFieldGet2,_classPrivateFieldGet3;const{keyword,limit}=query;const searchParams={query:keyword,limit,field:['normalizedTitle','headers','normalizedContent']};const searchResult=await Promise.all([(_classPrivateFieldGet2=(0,classPrivateFieldGet/* default */.Z)(this,_index))===null||_classPrivateFieldGet2===void 0?void 0:_classPrivateFieldGet2.search(searchParams),(_classPrivateFieldGet3=(0,classPrivateFieldGet/* default */.Z)(this,_cjkIndex))===null||_classPrivateFieldGet3===void 0?void 0:_classPrivateFieldGet3.search(searchParams)]);const flattenSearchResult=searchResult.flat(2).filter(Boolean);return flattenSearchResult;}}async function _getPages2(){const result=await fetch(// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-expect-error __ASSET_PREFIX__ is injected by webpack
`${""}/static/${shared_utils/* SEARCH_INDEX_JSON */.Zi}`);return result.json();}
;// CONCATENATED MODULE: ../../packages/cli/doc-core/src/theme-default/components/Search/logic/providers/RemoteProvider.ts
function buildQueryString(params){return Object.entries(params).map(pair=>pair.map(encodeURIComponent).join('=')).join('&');}var _options=/*#__PURE__*/new WeakMap();class RemoteProvider{constructor(){(0,classPrivateFieldInitSpec/* default */.Z)(this,_options,{writable:true,value:void 0});}async init(options){(0,classPrivateFieldSet/* default */.Z)(this,_options,options);}async search(query){const{apiUrl,searchIndexes}=(0,classPrivateFieldGet/* default */.Z)(this,_options);const{keyword,limit}=query;const urlParams=buildQueryString({keyword,limit:limit.toString(),searchIndexes:(searchIndexes===null||searchIndexes===void 0?void 0:searchIndexes.join(','))||''});const result=fetch(`${apiUrl}?${urlParams})`);return(await result).json();}}
;// CONCATENATED MODULE: ../../packages/cli/doc-core/src/theme-default/components/Search/logic/search.ts
const THRESHOLD_CONTENT_LENGTH=100;var search_options=/*#__PURE__*/new WeakMap();var _provider=/*#__PURE__*/new WeakMap();var _matchTitle=/*#__PURE__*/new WeakSet();var _matchHeader=/*#__PURE__*/new WeakSet();var _matchContent=/*#__PURE__*/new WeakSet();var _normalizeStatement=/*#__PURE__*/new WeakSet();class PageSearcher{constructor(options){(0,classPrivateMethodInitSpec/* default */.Z)(this,_normalizeStatement);(0,classPrivateMethodInitSpec/* default */.Z)(this,_matchContent);(0,classPrivateMethodInitSpec/* default */.Z)(this,_matchHeader);(0,classPrivateMethodInitSpec/* default */.Z)(this,_matchTitle);(0,classPrivateFieldInitSpec/* default */.Z)(this,search_options,{writable:true,value:void 0});(0,classPrivateFieldInitSpec/* default */.Z)(this,_provider,{writable:true,value:void 0});(0,classPrivateFieldSet/* default */.Z)(this,search_options,options);switch(options.mode){case'remote':(0,classPrivateFieldSet/* default */.Z)(this,_provider,new RemoteProvider());break;default:(0,classPrivateFieldSet/* default */.Z)(this,_provider,new LocalProvider());break;}}async init(){var _classPrivateFieldGet2;await((_classPrivateFieldGet2=(0,classPrivateFieldGet/* default */.Z)(this,_provider))===null||_classPrivateFieldGet2===void 0?void 0:_classPrivateFieldGet2.init((0,classPrivateFieldGet/* default */.Z)(this,search_options)));}async match(keyword,limit=7){var _classPrivateFieldGet3;const searchResult=await((_classPrivateFieldGet3=(0,classPrivateFieldGet/* default */.Z)(this,_provider))===null||_classPrivateFieldGet3===void 0?void 0:_classPrivateFieldGet3.search({keyword,limit}));const matchedResult=[];const normaizedKeyWord=normalizeTextCase(keyword);searchResult===null||searchResult===void 0?void 0:searchResult.forEach(item=>{// Title Match
(0,classPrivateMethodGet/* default */.Z)(this,_matchTitle,_matchTitle2).call(this,item,normaizedKeyWord,matchedResult);// Header match
const matchedHeader=(0,classPrivateMethodGet/* default */.Z)(this,_matchHeader,_matchHeader2).call(this,item,normaizedKeyWord,matchedResult);// If we have matched header, we don't need to match content
// Because the header is already in the content
if(matchedHeader){return;}// Content match
(0,classPrivateMethodGet/* default */.Z)(this,_matchContent,_matchContent2).call(this,item,normaizedKeyWord,matchedResult);});const res=(0,uniqBy/* default */.Z)(matchedResult,'link');return res;}}function _matchTitle2(item,query,matchedResult){const{title}=item;const normalizedTitle=normalizeTextCase(title);if(normalizedTitle.includes(query)){matchedResult.push({type:'title',title,header:title,link:`${item.domain}${(0,shared_utils/* normalizeHref */.yc)(item.routePath)}`,query,highlightIndex:normalizedTitle.indexOf(query),group:(0,classPrivateFieldGet/* default */.Z)(this,search_options).extractGroupName(item.routePath)});return true;}return false;}function _matchHeader2(item,query,matchedResult){const{toc,domain='',title}=item;for(const[index,header]of toc.entries()){const normalizedHeader=normalizeTextCase(header.text);if(normalizedHeader.includes(query)){// Find the all parent headers
// So we can show the full path of the header in search result
// e.g. header2 > header3 > header4
const headerGroup=backTrackHeaders(toc,index);const headerStr=headerGroup.map(item=>item.text).join(' > ');const headerMatchIndex=normalizeTextCase(headerStr).indexOf(query);const titlePrefix=`${title} > `;matchedResult.push({type:'header',title:item.title,header:`${titlePrefix}${headerStr}`,highlightIndex:titlePrefix.length+Number(headerMatchIndex),link:`${domain}${(0,shared_utils/* normalizeHref */.yc)(item.routePath)}#${header.id}`,query,group:(0,classPrivateFieldGet/* default */.Z)(this,search_options).extractGroupName(item.routePath)});return true;}}return false;}function _matchContent2(item,query,matchedResult){var _toc$currentHeaderInd;const{content,toc,domain}=item;const normalizedContent=normalizeTextCase(content);const queryIndex=normalizedContent.indexOf(query);if(queryIndex===-1){return;}const headersIndex=toc.map(h=>normalizedContent.indexOf(normalizeTextCase(h.text)));const currentHeaderIndex=headersIndex.findIndex((hIndex,position)=>{if(position<toc.length-1){const next=headersIndex[position+1];if(hIndex<=queryIndex&&next>=queryIndex){return true;}}else{return hIndex<queryIndex;}return false;});const currentHeader=(_toc$currentHeaderInd=toc[currentHeaderIndex])!==null&&_toc$currentHeaderInd!==void 0?_toc$currentHeaderInd:item.title;let statementStartIndex=content.slice(0,queryIndex).lastIndexOf('\n');statementStartIndex=statementStartIndex===-1?0:statementStartIndex;const statementEndIndex=content.indexOf('\n',queryIndex+query.length);let statement=content.slice(statementStartIndex,statementEndIndex);if(statement.length>THRESHOLD_CONTENT_LENGTH){statement=(0,classPrivateMethodGet/* default */.Z)(this,_normalizeStatement,_normalizeStatement2).call(this,statement,query);}matchedResult.push({type:'content',title:item.title,header:currentHeader.text,statement,highlightIndex:normalizeTextCase(statement).indexOf(query),link:`${domain}${(0,shared_utils/* normalizeHref */.yc)(item.routePath)}#${currentHeader.id}`,query,group:(0,classPrivateFieldGet/* default */.Z)(this,search_options).extractGroupName(item.routePath)});}function _normalizeStatement2(statement,query){// If statement is too long, we will only show 120 characters
const queryIndex=statement.indexOf(query);const maxPrefixOrSuffix=Math.floor((THRESHOLD_CONTENT_LENGTH-query.length)/2);let prefix=statement.slice(0,queryIndex);if(prefix.length>maxPrefixOrSuffix){prefix=`...${statement.slice(queryIndex-maxPrefixOrSuffix+3,queryIndex)}`;}let suffix=statement.slice(queryIndex+query.length);if(suffix.length>maxPrefixOrSuffix){suffix=`${statement.slice(queryIndex+query.length,queryIndex+maxPrefixOrSuffix-3)}...`;}return prefix+query+suffix;}
;// CONCATENATED MODULE: ../../packages/cli/doc-core/src/theme-default/components/Search/assets/file.svg
var file_circle, file_path, file_path2, file_path3;
...
const SvgFile = props => /*#__PURE__*/react.createElement("svg", file_extends({
  xmlns: "http://www.w3.org/2000/svg",
  width: 24,
  height: 24,
  viewBox: "0 0 32 32"
}, props), file_circle || (file_circle = /*#__PURE__*/react.createElement("circle", {
  cx: 22,
  cy: 24,
  r: 2,
  fill: "currentColor"
})), file_path || (file_path = /*#__PURE__*/react.createElement("path", {
  fill: "none",
  d: "M22 28a4 4 0 1 1 4-4a4.004 4.004 0 0 1-4 4Zm0-6a2 2 0 1 0 2 2a2.003 2.003 0 0 0-2-2Z"
  ...
  fill: "currentColor",
  d: "M12 28H8V4h8v6a2.006 2.006 0 0 0 2 2h6v4h2v-6a.91.91 0 0 0-.3-.7l-7-7A.909.909 0 0 0 18 2H8a2.006 2.006 0 0 0-2 2v24a2.006 2.006 0 0 0 2 2h4Zm6-23.6l5.6 5.6H18Z"
})));
/* harmony default export */ const file = (SvgFile);
;// CONCATENATED MODULE: ../../packages/cli/doc-core/src/theme-default/components/Search/assets/jump.svg
var jump_path;
function jump_extends() { jump_extends = Object.assign ? Object.assign.bind() : function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return jump_extends.apply(this, arguments); }

const SvgJump = props => /*#__PURE__*/react.createElement("svg", jump_extends({
  xmlns: "http://www.w3.org/2000/svg",
  width: 24,
  height: 24,
  viewBox: "0 0 32 32"
}, props), jump_path || (jump_path = /*#__PURE__*/react.createElement("path", {
  fill: "currentColor",
  d: "M13.414 17.586L18 22.172V8H8V6h10a2.002 2.002 0 0 1 2 2v14.172l4.586-4.586L26 19l-7 7l-7-7Z"
})));
/* harmony default export */ const jump = (SvgJump);
;// CONCATENATED MODULE: ../../packages/cli/doc-core/src/theme-default/components/Search/assets/header.svg
var header_path;
...
const SvgHeader = props => /*#__PURE__*/react.createElement("svg", header_extends({
  xmlns: "http://www.w3.org/2000/svg",
  width: 24,
  height: 24,
  viewBox: "0 0 32 32"
}, props), header_path || (header_path = /*#__PURE__*/react.createElement("path", {
  fill: "currentColor",
  d: "M28 12v-2h-6V4h-2v6h-8V4h-2v6H4v2h6v8H4v2h6v6h2v-6h8v6h2v-6h6v-2h-6v-8Zm-8 8h-8v-8h8Z"
})));
/* harmony default export */ const header = (SvgHeader);
;// CONCATENATED MODULE: ../../packages/cli/doc-core/src/theme-default/components/Search/assets/title.svg
var title_path;
...
const SvgTitle = props => /*#__PURE__*/react.createElement("svg", title_extends({
  xmlns: "http://www.w3.org/2000/svg",
  width: 24,
  height: 24,
  viewBox: "0 0 24 24"
}, props), title_path || (title_path = /*#__PURE__*/react.createElement("path", {
  fill: "currentColor",
  d: "M4 4a2 2 0 0 1 2-2h8a1 1 0 0 1 .707.293l5 5A1 1 0 0 1 20 8v12a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V4zm13.586 4L14 4.414V8h3.586zM12 4H6v16h12V10h-5a1 1 0 0 1-1-1V4z"
})));
/* harmony default export */ const title = (SvgTitle);
;// CONCATENATED MODULE: ../../packages/cli/doc-core/src/theme-default/components/Search/SuggestItem.tsx
const ICON_MAP={title:title,header:header,content:file};function SuggestItem({suggestion,closeSearch,isCurrent,setCurrentSuggestionIndex}){const HitIcon=ICON_MAP[suggestion.type];const{query}=suggestion;const renderHeaderMatch=()=>{if(suggestion.type==='header'||suggestion.type==='title'){const{header,highlightIndex}=suggestion;const headerPrefix=header.slice(0,highlightIndex);const queryStr=header.slice(highlightIndex,highlightIndex+query.length);const headerSuffix=header.slice(highlightIndex+query.length);return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{font:"medium",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("span",{children:headerPrefix}),/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:Search_index_module.mark,children:queryStr}),/*#__PURE__*/(0,jsx_runtime.jsx)("span",{children:headerSuffix})]});}else{return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{font:"medium",children:suggestion.header});}};const renderStatementMatch=()=>{if(suggestion.type!=='content'){return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{});}const{highlightIndex,statement}=suggestion;const statementPrefix=statement.slice(0,highlightIndex);const queryStr=statement.slice(highlightIndex,highlightIndex+query.length);const statementSuffix=statement.slice(highlightIndex+query.length);return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{text:"sm gray-light",w:"full",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("span",{children:statementPrefix}),/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:Search_index_module.mark,children:queryStr}),/*#__PURE__*/(0,jsx_runtime.jsx)("span",{children:statementSuffix})]});};let hitContent=null;switch(suggestion.type){case'title':case'header':hitContent=renderHeaderMatch();break;case'content':hitContent=/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[renderStatementMatch(),/*#__PURE__*/(0,jsx_runtime.jsx)("p",{className:Search_index_module.titleForContent,children:suggestion.title})]});break;default:break;}return/*#__PURE__*/(0,jsx_runtime.jsx)("li",{className:`${Search_index_module.suggestItem} ${isCurrent?Search_index_module.current:''}`,onMouseEnter:setCurrentSuggestionIndex,children:/*#__PURE__*/(0,jsx_runtime.jsx)("a",{href:suggestion.link,onClick:e=>{closeSearch();e.stopPropagation();},children:/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:Search_index_module.suggestItemContainer,children:[/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:Search_index_module.hitIcon,children:/*#__PURE__*/(0,jsx_runtime.jsx)(HitIcon,{})}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:Search_index_module.contentWrapper,children:/*#__PURE__*/(0,jsx_runtime.jsx)("span",{children:hitContent})}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:Search_index_module.actionIcon,children:/*#__PURE__*/(0,jsx_runtime.jsx)(jump,{})})]})})},suggestion.link);}
;// CONCATENATED MODULE: ../../packages/cli/doc-core/src/theme-default/components/Search/index.tsx
const KEY_CODE={ARROW_UP:'ArrowUp',ARROW_DOWN:'ArrowDown',ENTER:'Enter',SEARCH:'KeyK',ESC:'Escape'};function Search(){const[query,setQuery]=(0,react.useState)('');const[suggestions,setSuggestions]=(0,react.useState)([]);const[focused,setFocused]=(0,react.useState)(false);const searchInputRef=(0,react.useRef)(null);const[searching,setSearching]=(0,react.useState)(false);const[currentSuggestionIndex,setCurrentSuggestionIndex]=(0,react.useState)(0);const pageSearcherRef=(0,react.useRef)(null);const{siteData,lang}=(0,hooks/* usePageData */.V)();const{sidebar}=(0,useLocaleSiteData/* useLocaleSiteData */.M)();const{search}=siteData;// We need to extract the group name by the link so that we can divide the search result into different groups.
const extractGroupName=link=>(0,useSidebarData/* getSidebarGroupData */.s)(sidebar,link).group;async function initPageSearcher(){const pageSearcher=new PageSearcher((0,objectSpread2/* default */.Z)((0,objectSpread2/* default */.Z)({},search),{},{currentLang:lang,extractGroupName}));pageSearcherRef.current=pageSearcher;await pageSearcherRef.current.init();}(0,react.useEffect)(()=>{const onKeyDown=e=>{switch(e.code){case KEY_CODE.SEARCH:if(e.ctrlKey||e.metaKey){e.preventDefault();setFocused(!focused);}break;case KEY_CODE.ARROW_DOWN:e.preventDefault();setCurrentSuggestionIndex((currentSuggestionIndex+1)%suggestions.length);break;case KEY_CODE.ARROW_UP:e.preventDefault();setCurrentSuggestionIndex((currentSuggestionIndex-1+suggestions.length)%suggestions.length);break;case KEY_CODE.ENTER:if(currentSuggestionIndex>=0){const suggestion=suggestions[currentSuggestionIndex];window.location.href=suggestion.link;setFocused(false);}break;case KEY_CODE.ESC:setFocused(false);break;default:break;}};document.addEventListener('keydown',onKeyDown);return()=>{document.removeEventListener('keydown',onKeyDown);};});(0,react.useEffect)(()=>{if(focused&&!pageSearcherRef.current){initPageSearcher();}},[focused]);(0,react.useEffect)(()=>{initPageSearcher();// init pageSearcher again when lang changed
},[lang]);const onQueryChanged=async e=>{var _pageSearcherRef$curr;const newQuery=e.target.value;setQuery(newQuery);setSearching(true);const matched=await((_pageSearcherRef$curr=pageSearcherRef.current)===null||_pageSearcherRef$curr===void 0?void 0:_pageSearcherRef$curr.match(newQuery));setSearching(false);setSuggestions(matched||[]);};const showNotFound=query&&!searching&&suggestions.length===0;const normalizeSuggestions=suggestions=>(0,groupBy/* default */.Z)(suggestions,'group');const renderSearchResult=()=>{const normalizedSuggestions=normalizeSuggestions(suggestions);// accumulateIndex is used to calculate the index of the suggestion in the whole list.
let accumulateIndex=-1;return/*#__PURE__*/(0,jsx_runtime.jsx)("ul",{className:Search_index_module.suggestList,children:Object.keys(normalizedSuggestions).map(group=>{const groupSuggestions=normalizedSuggestions[group];return/*#__PURE__*/(0,jsx_runtime.jsxs)("li",{children:[/*#__PURE__*/(0,jsx_runtime.jsx)("h2",{className:Search_index_module.groupTitle,children:group}),/*#__PURE__*/(0,jsx_runtime.jsx)("ul",{children:groupSuggestions.map(suggestion=>{accumulateIndex++;const suggestionIndex=accumulateIndex;return/*#__PURE__*/(0,jsx_runtime.jsx)(SuggestItem,{suggestion:suggestion,isCurrent:suggestionIndex===currentSuggestionIndex,setCurrentSuggestionIndex:()=>setCurrentSuggestionIndex(suggestionIndex),closeSearch:()=>setFocused(false)},suggestion.link);})})]},group);})});};return/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:Search_index_module.navSearchButton,onClick:()=>setFocused(true),children:/*#__PURE__*/(0,jsx_runtime.jsxs)("button",{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(assets_search,{width:"18",hight:"18"}),/*#__PURE__*/(0,jsx_runtime.jsx)("p",{className:Search_index_module.searchWord,children:"Search"}),/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{children:[/*#__PURE__*/(0,jsx_runtime.jsx)("span",{children:"\u2318"}),/*#__PURE__*/(0,jsx_runtime.jsx)("span",{children:"K"})]})]})}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:Search_index_module.mobileNavSearchButton,onClick:()=>setFocused(true),children:/*#__PURE__*/(0,jsx_runtime.jsx)(assets_search,{})}),focused&&/*#__PURE__*/(0,react_dom.createPortal)(/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:Search_index_module.mask,onClick:()=>setFocused(false),children:/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:`${Search_index_module.modal}`,onClick:e=>{setFocused(true);e.stopPropagation();},children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"flex items-center",children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:Search_index_module.inputForm,children:[/*#__PURE__*/(0,jsx_runtime.jsx)("label",{children:/*#__PURE__*/(0,jsx_runtime.jsx)(assets_search,{})}),/*#__PURE__*/(0,jsx_runtime.jsx)("input",{className:Search_index_module.input,ref:searchInputRef,placeholder:"Search Docs","aria-label":"Search",autoComplete:"off",autoFocus:true,onChange:onQueryChanged}),/*#__PURE__*/(0,jsx_runtime.jsx)("label",{children:/*#__PURE__*/(0,jsx_runtime.jsx)(assets_close,{className:Search_index_module.close,onClick:()=>{if(searchInputRef.current){searchInputRef.current.value='';}}})})]}),/*#__PURE__*/(0,jsx_runtime.jsx)("h2",{className:"text-brand ml-2 sm:hidden cursor-pointer",onClick:e=>{e.stopPropagation();setFocused(false);},children:"Cancel"})]}),query&&suggestions.length?/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:`${Search_index_module.searchHits}  modern-scrollbar`,children:renderSearchResult()}):null,searching&&/*#__PURE__*/(0,jsx_runtime.jsx)("div",{flex:"~ center",children:/*#__PURE__*/(0,jsx_runtime.jsx)("div",{p:"2",text:"sm",children:/*#__PURE__*/(0,jsx_runtime.jsx)(loading,{})})}),showNotFound&&/*#__PURE__*/(0,jsx_runtime.jsx)("div",{flex:"~ center",className:"mt-4",children:/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{p:"2",font:"bold",text:"md #2c3e50",children:["No results found for \"",query,"\""]})})]})}),document.getElementById('search-container'))]});}
...
/******/ __webpack_require__.O(0, [92986,87991,58193,3313], () => (__webpack_exec__(76645), __webpack_exec__(74224)));
