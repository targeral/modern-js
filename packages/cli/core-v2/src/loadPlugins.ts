...
import { CliPlugin, getManagerAPI } from './manager';
...
export type TransformPlugin<UserConfig> = (
  plugin: PluginConfig,
...
const resolveCliPlugin = <UserConfig>(
  p: PluginItem,
  ...
  if (typeof module === 'function') {
    ...
    const { createPlugin } = getManagerAPI<UserConfig>();
 ...
 */
export const loadPlugins = <UserConfig>(
  appDirectory: string,
  userConfig: UserConfig,
  options: {
    internalPlugins?: typeof INTERNAL_PLUGINS;
