...
`,o(e.p,{children:"\u5C06\u6587\u4EF6\u6216\u76EE\u5F55\u62F7\u8D1D\u5230\u6307\u5B9A\u4F4D\u7F6E\u3002"}),`
`,t(e.ul,{children:[`
`,t(e.li,{children:["type: ",o(e.code,{children:"Object"})]}),`
`]}),`
`,o(n.Code,{codeConfig:r,northPanel:{tabs:[""],active:"",heightRatio:1},files:[{name:"",focus:"",code:{lines:[{tokens:[]},{tokens:[{content:"export",props:{style:{color:"#81A1C1"}}},{content:" ",props:{style:{color:"#D8DEE9FF"}}},{content:"default",props:{style:{color:"#81A1C1"}}},{content:" ",props:{style:{color:"#D8DEE9FF"}}},{content:"{",props:{style:{color:"#ECEFF4"}}}]},{tokens:[{content:"  ",props:{style:{color:"#D8DEE9FF"}}},{content:"buildConfig",props:{style:{color:"#88C0D0"}}},{content:":",props:{style:{color:"#ECEFF4"}}},{content:" ",props:{style:{color:"#D8DEE9FF"}}},{content:"{",props:{style:{color:"#ECEFF4"}}}]},{tokens:[{content:"    ",props:{style:{color:"#D8DEE9FF"}}},{content:"copy",props:{style:{color:"#88C0D0"}}},{content:":",props:{style:{color:"#ECEFF4"}}},{content:" ",props:{style:{color:"#D8DEE9FF"}}},{content:"{",props:{style:{color:"#ECEFF4"}}}]},{tokens:[{content:"      ",props:{style:{color:"#D8DEE9FF"}}},{content:"patterns",props:{style:{color:"#88C0D0"}}},{content:":",props:{style:{color:"#ECEFF4"}}},{content:" [",props:{style:{color:"#D8DEE9FF"}}},{content:"{",props:{style:{color:"#ECEFF4"}}},{content:" ",props:{style:{color:"#D8DEE9FF"}}},{content:"from",props:{style:{color:"#88C0D0"}}},{content:":",props:{style:{color:"#ECEFF4"}}},{content:" ",props:{style:{color:"#D8DEE9FF"}}},{content:"'",props:{style:{color:"#ECEFF4"}}},{content:"./src/assets",props:{style:{color:"#A3BE8C"}}},{content:"'",props:{style:{color:"#ECEFF4"}}},{content:",",props:{style:{color:"#ECEFF4"}}},{content:" ",props:{style:{color:"#D8DEE9FF"}}},{content:"to",props:{style:{color:"#88C0D0"}}},{content:":",props:{style:{color:"#ECEFF4"}}},{content:" ",props:{style:{color:"#D8DEE9FF"}}},{content:"''",props:{style:{color:"#ECEFF4"}}},{content:" ",props:{style:{color:"#D8DEE9FF"}}},{content:"}",props:{style:{color:"#ECEFF4"}}},{content:"]",props:{style:{color:"#D8DEE9FF"}}},{content:",",props:{style:{color:"#ECEFF4"}}}]},{tokens:[{content:"    ",props:{style:{color:"#D8DEE9FF"}}},{content:"},",props:{style:{color:"#ECEFF4"}}}]},{tokens:[{content:"  ",props:{style:{color:"#D8DEE9FF"}}},{content:"},",props:{style:{color:"#ECEFF4"}}}]},{tokens:[{content:"}",props:{style:{color:"#ECEFF4"}}},{content:";",props:{style:{color:"#81A1C1"}}}]}],lang:"js"},annotations:[]}]}),`
`,t(e.h3,{id:"copypatterns",children:[o(e.a,{className:"header-anchor","aria-hidden":"true",href:"#copypatterns",children:"#"}),o(e.code,{children:"copy.patterns"})]}),`
`,t(e.ul,{children:[`
`,t(e.li,{children:["type: ",o(e.code,{children:"CopyPattern[]"})]}),`
...
`,t(e.h3,{id:"copyoptions",children:[o(e.a,{className:"header-anchor","aria-hidden":"true",href:"#copyoptions",children:"#"}),"copy.options"]}),`
`,t(e.ul,{children:[`
`,t(e.li,{children:["type: ",o(e.code,{children:"Object"})]}),`
`,t(e.li,{children:["default: ",o(e.code,{children:"{ concurrency: 100, enableCopySync: false }"})]}),`
`]}),`
...
`,t(e.ul,{children:[`
`,t(e.li,{children:[o(e.code,{children:"concurrency"}),": \u6307\u5B9A\u5E76\u884C\u6267\u884C\u591A\u5C11\u4E2A\u590D\u5236\u4EFB\u52A1\u3002"]}),`
`,t(e.li,{children:[o(e.code,{children:"enableCopySync"}),": \u4F7F\u7528 ",o(e.a,{href:"https://github.com/jprichardson/node-fs-extra/blob/master/lib/copy/copy-sync.js",target:"_blank",rel:"nofollow",children:o(e.code,{children:"fs.copySync"})}),"\uFF0C\u9ED8\u8BA4\u60C5\u51B5\u4E0B ",o(e.a,{href:"https://github.com/jprichardson/node-fs-extra/blob/master/lib/copy/copy.js",target:"_blank",rel:"nofollow",children:o(e.code,{children:"fs.copy"})}),"\u3002"]}),`
`]}),`
...
\`\`\`
`;export{n as CH,r as chCodeConfig,f as content,m as default,y as frontmatter,D as lastUpdatedTime,g as title,h as toc};
