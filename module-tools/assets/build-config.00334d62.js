...
`,t(e.p,{children:["Static resource output path, will be based on ",o(e.a,{href:"/zh/api/build-config/#outdir",children:"outdir"})]}),`
`,t(e.ul,{children:[`
...
`,t(e.p,{children:["The output path of the dts file, based on ",o(e.a,{href:"/'/zh/api/build-config/#outdir'",children:"outdir"})]}),`
`,t(e.ul,{children:[`
`,t(e.li,{children:["type: ",o(e.code,{children:"string"})]}),`
...
`,t(e.p,{children:["The ",o(e.code,{children:"theme"})," property is not allowed, otherwise the build will fail, using ",o(e.a,{href:"/zh/api/design-system",children:o(e.code,{children:"designSystem"})})," as the ",o(e.code,{children:"Tailwind CSS Theme"})," configuration."]}),`
...
`,o(n.Code,{codeConfig:r,northPanel:{tabs:[""],active:"",heightRatio:1},files:[{name:"",focus:"",code:{lines:[{tokens:[{content:"At this point the umd product will go to mount on `global.myLib`",props:{}}]},{tokens:[{content:":::tip",props:{}}]},{tokens:[{content:"- The module name of the umd product must not conflict with the global variable name.",props:{}}]},{tokens:[{content:"- Module names should not contain special characters like `-`, `@`, `/`, etc.",props:{}}]},{tokens:[{content:":::",props:{}}]},{tokens:[{content:"",props:{}}]},{tokens:[{content:"Also the function form can take one parameter, which is the output path of the current package file",props:{}}]},{tokens:[{content:"```js modern.config.ts",props:{}}]},{tokens:[{content:"export default {",props:{}}]},{tokens:[{content:"  buildConfig: {",props:{}}]},{tokens:[{content:"    format: 'umd',",props:{}}]},{tokens:[{content:"    umdModuleName: (path) => {",props:{}}]},{tokens:[{content:"      if (path.includes('index')) {",props:{}}]},{tokens:[{content:"        return 'myLib';",props:{}}]},{tokens:[{content:"      } else {",props:{}}]},{tokens:[{content:"        return 'myLib2';",props:{}}]},{tokens:[{content:"      }",props:{}}]},{tokens:[{content:"    },",props:{}}]},{tokens:[{content:"  }",props:{}}]},{tokens:[{content:"}",props:{}}]}],lang:"text"},annotations:[]}]})]})}function F(s={}){const{wrapper:e}=s.components||{};return e?o(e,Object.assign({},s,{children:o(c,s)})):c(s)}function i(s,e){throw new Error("Expected "+(e?"component":"object")+" `"+s+"` to be defined: you likely forgot to import, pass, or provide it.")}const m="2022/12/20 13:14:20",b=`# BuildConfig
...
\`\`\`
`;export{n as CH,r as chCodeConfig,b as content,F as default,f as frontmatter,m as lastUpdatedTime,y as title,E as toc};
