...
`,o(e.p,{children:["The microgenerator can be started via ",n(e.a,{href:"/module-tools/zh/guide/command-preview",children:n(e.code,{children:"modern new"})}),". The current Microgenerator features supported by the Module Engineering program are:"]}),`
...
`,o(e.ul,{children:[`
`,n(e.li,{children:n(e.a,{href:"/module-tools/en/guide/command-preview#modern-dev",children:n(e.code,{children:"modern dev"})})}),`
`,n(e.li,{children:n(e.a,{href:"/module-tools/xxx",children:"using Storybook"})}),`
`]}),`
...
`,o(e.ul,{children:[`
`,n(e.li,{children:n(e.a,{href:"/module-tools/xxx",children:"Using Tailwind CSS"})}),`
`]}),`
