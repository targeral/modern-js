...
`,t(e.p,{children:["Static resource output path, will be based on ",o(e.a,{href:"/module-tools/zh/api/build-config/#outDir",children:"outDir"})]}),`
`,t(e.ul,{children:[`
...
`,o(e.p,{children:"Threshold for automatically inlining static resources when building, resources less than 10 KB will be automatically inlined into the bundle product"}),`
`,t(e.ul,{children:[`
...
`,t(e.p,{children:["Packaged to handle svg as a React component, options reference ",o(e.a,{href:"https://react-svgr.com/docs/options/",target:"_blank",rel:"nofollow",children:"svgr"}),", plus support for two configuration items ",o(e.code,{children:"include"})," and ",o(e.code,{children:"exclude"})," to match the svg file to be handled"]}),`
`,t(e.ul,{children:[`
...
`,t(e.p,{children:["The output path of the dts file, based on ",o(e.a,{href:"/module-tools/zh/api/build-config/#outDir",children:"outDir"})]}),`
`,t(e.ul,{children:[`
`,t(e.li,{children:["type: ",o(e.code,{children:"string"})]}),`
...
`,t(e.h3,{id:"tailwindcss",children:[o(e.a,{className:"header-anchor","aria-hidden":"true",href:"#tailwindcss",children:"#"}),"tailwindcss"]}),`
...
`,t(e.p,{children:["The ",o(e.code,{children:"theme"})," property is not allowed, otherwise the build will fail, using ",o(e.a,{href:"/module-tools/zh/api/design-system",children:o(e.code,{children:"designSystem"})})," as the ",o(e.code,{children:"Tailwind CSS Theme"})," configuration."]}),`
...
`,t(e.li,{children:["default: ",o(e.code,{children:"{}"})]}),`
`]}),`
`,o(n.Code,{codeConfig:r,northPanel:{tabs:["modern.config.ts"],active:"modern.config.ts",heightRatio:1},files:[{name:"modern.config.ts",focus:"",code:{lines:[{tokens:[{content:"export",props:{style:{color:"#81A1C1"}}},{content:" ",props:{style:{color:"#D8DEE9FF"}}},{content:"default",props:{style:{color:"#81A1C1"}}},{content:" ",props:{style:{color:"#D8DEE9FF"}}},{content:"{",props:{style:{color:"#ECEFF4"}}}]},{tokens:[{content:"  ",props:{style:{color:"#D8DEE9FF"}}},{content:"buildConfig",props:{style:{color:"#88C0D0"}}},{content:":",props:{style:{color:"#ECEFF4"}}},{content:" ",props:{style:{color:"#D8DEE9FF"}}},{content:"{",props:{style:{color:"#ECEFF4"}}}]},{tokens:[{content:"    ",props:{style:{color:"#D8DEE9FF"}}},{content:"umdGlobals",props:{style:{color:"#88C0D0"}}},{content:":",props:{style:{color:"#ECEFF4"}}},{content:" ",props:{style:{color:"#D8DEE9FF"}}},{content:"{",props:{style:{color:"#ECEFF4"}}}]},{tokens:[{content:"      ",props:{style:{color:"#D8DEE9FF"}}},{content:"react",props:{style:{color:"#88C0D0"}}},{content:":",props:{style:{color:"#ECEFF4"}}},{content:" ",props:{style:{color:"#D8DEE9FF"}}},{content:"'",props:{style:{color:"#ECEFF4"}}},{content:"React",props:{style:{color:"#A3BE8C"}}},{content:"'",props:{style:{color:"#ECEFF4"}}},{content:",",props:{style:{color:"#ECEFF4"}}}]},{tokens:[{content:"      ",props:{style:{color:"#D8DEE9FF"}}},{content:"'",props:{style:{color:"#ECEFF4"}}},{content:"react-dom",props:{style:{color:"#A3BE8C"}}},{content:"'",props:{style:{color:"#ECEFF4"}}},{content:":",props:{style:{color:"#ECEFF4"}}},{content:" ",props:{style:{color:"#D8DEE9FF"}}},{content:"'",props:{style:{color:"#ECEFF4"}}},{content:"ReactDOM",props:{style:{color:"#A3BE8C"}}},{content:"'",props:{style:{color:"#ECEFF4"}}},{content:",",props:{style:{color:"#ECEFF4"}}}]},{tokens:[{content:"    ",props:{style:{color:"#D8DEE9FF"}}},{content:"},",props:{style:{color:"#ECEFF4"}}}]},{tokens:[{content:"  ",props:{style:{color:"#D8DEE9FF"}}},{content:"}",props:{style:{color:"#ECEFF4"}}}]},{tokens:[{content:"}",props:{style:{color:"#ECEFF4"}}}]}],lang:"js"},annotations:[]}]}),`
...
`,t(e.p,{children:["At this point the umd product will go to mount on ",o(e.code,{children:"global.myLib"})]}),`
...
\`\`\`
`;export{n as CH,r as chCodeConfig,b as content,f as default,E as frontmatter,m as lastUpdatedTime,y as title,F as toc};
