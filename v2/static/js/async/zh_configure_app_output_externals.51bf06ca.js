...
const externals_content = "\"---\\nsidebar_label: externals\\n---\\n\\n# output.externals\\n\\n:::tip\\n该配置由 Modern.js Builder 提供，更多信息可参考 [output.externals](https://modernjs.dev/builder/api/config-output.html#output-externals)。\\n:::\\n\\nimport Main from '@modern-js/builder-doc/docs/zh/config/output/externals.md'\\n\\n<Main />\\n\"";
