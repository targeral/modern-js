...
const ts_checker_content = "\"---\\nsidebar_label: tsChecker\\n---\\n\\n# tools.tsChecker\\n\\n:::tip\\nThis config is provided by Modern.js Builder, more detail can see [tools.tsChecker](https://modernjs.dev/builder/en/api/config-tools.html#tools-tschecker)。\\n:::\\n\\nimport Main from '@modern-js/builder-doc/docs/en/config/tools/tsChecker.md'\\n\\n<Main />\\n\"";
      ...
      children: [(0,jsx_runtime.jsx)(_components.p, {
        ...
        children: (0,jsx_runtime.jsxs)(_components.p, {
          children: ["\nThis config is provided by Modern.js Builder, more detail can see ", (0,jsx_runtime.jsx)(_components.a, {
            href: "https://modernjs.dev/builder/en/api/config-tools.html#tools-tschecker-3",
            target: "_blank",
            rel: "nofollow",
