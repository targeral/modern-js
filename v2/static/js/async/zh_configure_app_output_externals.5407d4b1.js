"use strict";
(self["webpackChunk_modern_js_main_doc_website"] = self["webpackChunk_modern_js_main_doc_website"] || []).push([[7843],{
...
__webpack_require__.d(__webpack_exports__, {
  "content": () => (/* binding */ externals_content),
...
;// CONCATENATED MODULE: ../../packages/builder/builder-doc/docs/zh/config/output/externals.md
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.ul, {
      ...
      children: ["在构建时，防止将代码中某些 ", (0,jsx_runtime.jsx)(_components.code, {
        children: "import"
      }), " 的依赖包打包到 bundle 中，而是在运行时再去从外部获取这些依赖。"]
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["详情请见: ", (0,jsx_runtime.jsx)(_components.a, {
        href: "https://webpack.docschina.org/configuration/externals/",
        target: "_blank",
        rel: "nofollow",
        children: "webpack 外部扩展 (Externals)"
      })]
      ...
      children: ["将 ", (0,jsx_runtime.jsx)(_components.code, {
        children: "react-dom"
      }), " 依赖从构建产物中剔除。为了在运行时获取这个模块, ", (0,jsx_runtime.jsx)(_components.code, {
        children: "react-dom"
      }), " 的值将全局检索 ", (0,jsx_runtime.jsx)(_components.code, {
        children: "ReactDOM"
      }), " 变量。"]
...
;// CONCATENATED MODULE: ../../packages/toolkit/main-doc/zh/configure/app/output/externals.mdx
/*@jsxRuntime automatic @jsxImportSource react*/
...
const externals_toc = [];
const title = `externals`;
const externals_content = "\"---\\ntitle: output.externals\\nsidebar_label: externals\\n---\\n# externals\\n\\n:::info BUILDER\\n该配置为 Modern.js Builder 配置，详细信息可参考 [output.externals](https://modernjs.dev/builder/api/config-output.html#output-externals)。\\n:::\\n\\nimport Main from '@modern-js/builder-doc/docs/zh/config/output/externals.md'\\n\\n<Main />\\n\"";
      ...
      children: [(0,jsx_runtime.jsx)(_components.p, {
        ...
        children: (0,jsx_runtime.jsxs)(_components.p, {
          children: ["\n该配置为 Modern.js Builder 配置，详细信息可参考 ", (0,jsx_runtime.jsx)(_components.a, {
            href: "https://modernjs.dev/builder/api/config-output.html#output-externals-2",
            target: "_blank",
            rel: "nofollow",
