...
__webpack_require__.d(__webpack_exports__, {
  "content": () => (/* binding */ svg_default_export_content),
...
const title = `svgDefaultExport`;
const svg_default_export_content = "\"---\\ntitle: output.svgDefaultExport\\nsidebar_label: svgDefaultExport\\n---\\n# svgDefaultExport\\n\\n:::info BUILDER\\nThis configuration is Modern.js Builder configuration, more detail can see [output.svgDefaultExport](https://modernjs.dev/builder/en/api/config-output.html#output-svgdefaultexport)。\\n:::\\n\\nimport Main from '@modern-js/builder-doc/docs/en/config/output/svgDefaultExport.md'\\n\\n<Main />\\n\"";
      ...
      children: [(0,jsx_runtime.jsx)(_components.p, {
        ...
        children: (0,jsx_runtime.jsxs)(_components.p, {
          children: ["\nThis configuration is Modern.js Builder configuration, more detail can see ", (0,jsx_runtime.jsx)(_components.a, {
            href: "https://modernjs.dev/builder/en/api/config-output.html#output-svgdefaultexport-3",
            target: "_blank",
            rel: "nofollow",
            children: "output.svgDefaultExport"
          }), "。"]
