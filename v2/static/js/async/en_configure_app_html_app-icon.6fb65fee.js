"use strict";
(self["webpackChunk_modern_js_main_doc_website"] = self["webpackChunk_modern_js_main_doc_website"] || []).push([[29892],{
...
;// CONCATENATED MODULE: ../../packages/builder/builder-doc/docs/en/config/html/appIcon.md
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.ul, {
      ...
      children: "Set the file path of the app icon, can be set as a relative path relative to the project root directory, or as an absolute path to the file. Setting it as a CDN URL is not currently supported."
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["After config this option, the icon will be automatically copied to the dist directory during the compilation, and the corresponding ", (0,jsx_runtime.jsx)(_components.code, {
        children: "link"
...
;// CONCATENATED MODULE: ../../packages/toolkit/main-doc/en/configure/app/html/app-icon.mdx
/*@jsxRuntime automatic @jsxImportSource react*/
      ...
      children: [(0,jsx_runtime.jsx)(_components.p, {
        ...
        children: (0,jsx_runtime.jsxs)(_components.p, {
          children: ["\nThis config is provided by Modern.js Builder, more detail can see ", (0,jsx_runtime.jsx)(_components.a, {
            href: "https://modernjs.dev/builder/en/api/config-html.html#html-appicon-3",
            target: "_blank",
            rel: "nofollow",
